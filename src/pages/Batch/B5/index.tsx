...
const demoData: FinalItem[] = [
  ...
  },
  {
    ...
    status: 'approved',
    isAIReviewed: true,
    reviewSuggestion: '论文结构完整，内容详实',
    reviewTime: '2025-06-12',
  ...
  },
  {
    ...
    status: 'returned',
    isAIReviewed: true,
    reviewSuggestion: '需要补充实验数据',
    reviewTime: '2025-06-13',
...
const columns: ProColumns<FinalItem>[] = [
  ...
  { title: '终审教师', dataIndex: 'finalReviewer' },
  { title: '版本', dataIndex: 'version' },
  { title: '状态', dataIndex: 'status' },
  { title: '终审状态', dataIndex: 'finalStatus' },
  { title: '论文成绩', dataIndex: 'score' },
  { title: '成绩等级', dataIndex: 'grade' },
  { title: '是否AI审核', dataIndex: 'isAIReviewed', valueType: 'checkbox' },
  { title: '创建时间', dataIndex: 'createTime', valueType: 'date' },
];

const BatchB5Page: React.FC = () => {
