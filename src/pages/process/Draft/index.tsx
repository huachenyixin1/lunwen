...
const columns: ProColumns<DraftItem>[] = [
  ...
  { title: '论文初稿文件', dataIndex: 'file', width: 180, render: (text) => <a href="#" download>{text}</a> },
...
const Draft: React.FC = () => {
  ...
  const [selectedRows, setSelectedRows] = useState<DraftItem[]>([]);
  ...
  return (
    <PageContainer>
      ...
      >
        ...
        >
          <Button icon={<UploadOutlined />}>上传论文初稿（.doc/.docx）</Button>
        </Upload>
      </Modal>
    </PageContainer>
  );
